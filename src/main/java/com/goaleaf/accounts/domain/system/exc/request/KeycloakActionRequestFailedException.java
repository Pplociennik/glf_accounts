...
/**
 * An exception being thrown when the keycloak action request failed.
 *
 * @author Created by: Pplociennik at 27.04.2025 21:05
 */
public class KeycloakActionRequestFailedException extends BaseRuntimeException {
     ...
     */
    public KeycloakActionRequestFailedException( TranslationKey aTranslationKey, Serializable... aParams ) {
     ...
     *         the translation key used to retrieve the localized message
     */
    public KeycloakActionRequestFailedException( TranslationKey aTranslationKey ) {
     ...
     *         optional parameters for constructing the localized message.
     */
    public KeycloakActionRequestFailedException( Throwable aCause, TranslationKey aMessageKey, Serializable... aParams ) {
     ...
     */
    public KeycloakActionRequestFailedException( String message ) {
        super( message );
    }
     ...
     * @since 1.4
     */
    public KeycloakActionRequestFailedException( String message, Throwable cause ) {
        super( message, cause );
    }
}
