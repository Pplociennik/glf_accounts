package com.goaleaf.accounts.domain.system.exc.request;
...
/**
 * An exception being thrown when the keycloak resource request failed.
 *
 * @author Created by: Pplociennik at 27.04.2025 21:01
 */
public class KeycloakResourceRequestFailedException extends BaseRuntimeException {
     ...
     */
    public KeycloakResourceRequestFailedException( TranslationKey aTranslationKey, Serializable... aParams ) {
     ...
     *         the translation key used to retrieve the localized message
     */
    public KeycloakResourceRequestFailedException( TranslationKey aTranslationKey ) {
     ...
     *         optional parameters for constructing the localized message.
     */
    public KeycloakResourceRequestFailedException( Throwable aCause, TranslationKey aMessageKey, Serializable... aParams ) {
     ...
     */
    public KeycloakResourceRequestFailedException( String message ) {
        super( message );
    }
     ...
     * @since 1.4
     */
    public KeycloakResourceRequestFailedException( String message, Throwable cause ) {
        super( message, cause );
    }
}
