package com.goaleaf.accounts.domain.system.util.token;
 ...
 * An implementation of {@link AccessTokenValidationStrategy}, it uses the {@link KeycloakClient}
 ...
 * @implNote The {@link OnlineValidationStrategy} relies on {@link KeycloakClient} for communication
...
public final class OnlineValidationStrategy implements AccessTokenValidationStrategy {
    ...
    /**
     * An instance of {@link  KeycloakClient} used for interacting with
    ...
    public boolean validateAccessToken( @NonNull String aToken ) {
        ...
        return keycloakClient.sendTokenIntrospectionRequest( aToken );
    }
}
