package com.goaleaf.accounts.infrastructure.account;
...
import com.goaleaf.accounts.api.dto.account.PasswordChangingRequestDto;
import com.goaleaf.accounts.api.dto.account.PasswordResetRequestDto;
...
import com.goaleaf.accounts.domain.system.exc.auth.AccountAlreadyVerifiedException;
...
import com.goaleaf.accounts.domain.system.exc.request.KeycloakResourceRequestFailedException;
...
import static com.goaleaf.accounts.domain.system.util.KeycloakUrlTemplates.*;
...
class AccountServiceImpl implements AccountService {
     ...
     */
    private final KeycloakClient keycloakConnectionService;
    ...
    /**
     * A service providing functionalities related to the {@link UserDetailsEntity}.
     */
    ...
    public void sendCredentialsResetLink( PasswordResetRequestDto aDto ) {
        ...
        if ( userExists ) {
            String realmName = systemPropertiesReaderService.readProperty( KEYCLOAK_REALM_NAME );
            String clientAccessToken = keycloakConnectionService.getClientAccessToken();
            UserDetails details = userDetailsService.findUserDetailsByEmail( aDto.getEmail() );
    ...
    private String getUserId( String aEmailAddress ) {
        UserDetails details = userDetailsService.findUserDetailsByEmail( aEmailAddress );
