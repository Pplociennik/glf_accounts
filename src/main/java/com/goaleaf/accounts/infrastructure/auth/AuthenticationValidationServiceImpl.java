...
class AuthenticationValidationServiceImpl implements AuthenticationValidationService {
    ...
    /**
     * An injected instance of the {@link UserDetailsDao}.
     */
    private final UserDetailsDao userDetailsDao;

    @Autowired
    AuthenticationValidationServiceImpl( UserDetailsDao aUserDetailsDao ) {
        this.userDetailsDao = aUserDetailsDao;
    }
    ...
    public boolean validatePasswordResetRequest( @NonNull String aEmail ) {
        ...
        return userDetailsDao.findByEmailAddress( aEmail ).isPresent();
    }
